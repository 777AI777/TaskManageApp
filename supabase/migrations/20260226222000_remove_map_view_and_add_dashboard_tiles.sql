...
where selected_view is null
   or selected_view not in ('board', 'calendar', 'table', 'timeline', 'dashboard');
...
begin
  ...
  alter table public.user_board_preferences
    ...
    check (selected_view in ('board', 'calendar', 'table', 'timeline', 'dashboard'));
end
$$;
